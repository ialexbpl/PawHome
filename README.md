...
git clone https://github.com/ialexbpl/PawHome.git
cd pawhome
...
Then patch `k8s/web-deployment-service.yaml`:
...
├── DEPLOYMENT_PLAN.md          # Cluster deployment runbook
...
└── analysis/                   # Generated by benchmark.py (gitignored)
```
